...
for i in range(len(old)):
	endpoint = 'https://search-restaurants-2j2gtpc5xsc5w5atrwwyjun3ra.us-east-1.es.amazonaws.com/restaurants/Restaurant/' + str(i)
	initial = "curl -XPUT https://search-restaurants-2j2gtpc5xsc5w5atrwwyjun3ra.us-east-1.es.amazonaws.com/restaurants/Restaurant/{} -d ".format(i)
