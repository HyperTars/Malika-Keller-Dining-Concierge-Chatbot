...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAIDUXGNIDJ2XAZSEQ',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://vwmdfhmulh.execute-api.us-east-1.amazonaws.com/dinning_api_deploy';
